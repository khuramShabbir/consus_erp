...
import 'package:consus_erp/controllers/profile_controller.dart';
        ...
        builder: (controller) {
          return Scaffold(
            body: SingleChildScrollView(
              child: Container(
                padding: FxSpacing.fromLTRB(20, FxSpacing.safeAreaTop(context) + 16, 20, 0),
                child: Column(
      ...
      children: [
        ...
        Center(
          child: FxButton(
              ...
              onPressed: () async {
                bool result = await Provider.of<LoginProvider>(context, listen: false).logout();
        ...
        //       borderRadiusAll: Constant.buttonRadius.small,
        //       onPressed: () {
        //         //ImportDataFromJson item = new ImportDataFromJson();
        //         //item.fetchItems();
        //         //item.fetchShops();
        //         //item.fetchSalePersons();
        //         //item.fetchRegions();
        //         //item.fetchAreas();
        //         //item.fetchBranches();
        //         //item.fetchTcs();
        //         DatabaseHelper.instance.deleteAll();
        //         Info.successSnackBar('Area deleted successfully!!!');
        //       },
        //       child: FxText(
        //         'Import Items',
        //         color: theme.colorScheme.onErrorContainer,
        ...
        //     borderRadiusAll: Constant.buttonRadius.small,
        //     onPressed: () {
        //       Navigator.push(context, MaterialPageRoute(builder: (context) => ImportData()));
        //     },
        //     child: FxText(
        //       'Test List',
        //       color: theme.colorScheme.onErrorContainer,
